...
var MessageInputComponent = (function () {
    ...
    MessageInputComponent.prototype.onSubmit = function (form) {
        if (this.message) {
            ...
            this.messageService.updateMessage(this.message).subscribe(function (result) { return console.log(result); });
        }
        else {
            // Create
            var message = new message_model_1.Message(form.value.content, 'Quy');
